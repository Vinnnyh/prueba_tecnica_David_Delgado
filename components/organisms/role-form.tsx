...
export const RoleForm = ({ role, allPermissions, onSave, onClose, isSaving, canEdit = true }: RoleFormProps) => {
    ...
    setSelectedPermissions((prev) => {
      ...
      if (isSelecting) {
        ...
        if (basePermissionName) {
          const basePermission = allPermissions.find(p => p.name === basePermissionName);
